...
heatmapdat <- indic$str %>% 
  ...
  pivot_longer(cols = c("eelgrass_edna":"eelgrass_seine+kelp_seine+mixed_seine"),
  ...
  mutate(comb = ifelse(comb == "eelgrass_edna",
                ...
                ifelse(comb == "mixed_edna+mixed_seine", "eDNA & seine: mixed", comb)))))))))))))))))) %>%
...
# subset the species by the ones that are significant 
#ggsave(plot = isa.plot, filename = "Images/draft_isa_plot.png", width = 14, height = 8)
```
...
# ggsave(filename = "Images/Relative_abund_heatmap_sites.jpg",
...
#        filename = "Images/Eelg_relative_abund_heat.jpg") 
# ggsave(plot = heatmaps[[2]], height = 12, width = 16,
#        filename = "Images/Kelp_relative_abund_heat.jpg")
# ggsave(plot = heatmaps[[3]], height = 12, width = 16, 
#        filename = "Images/Mixed_relative_abund_heat.jpg")
```
