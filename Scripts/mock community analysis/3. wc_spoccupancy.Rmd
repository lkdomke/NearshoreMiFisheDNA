...
out.1 <- intMsPGOcc(occ.formula = ~ as.factor(habitat) + as.factor(region),
                    ...
                    n.samples = 50,000, # number of iterations, default was 6000; 50,000 takes like ~35 min and has nice ESS and Rhats but is a big unweildly for some of the outputs. Can also try 30,000 that is perhaps a better run time. 
