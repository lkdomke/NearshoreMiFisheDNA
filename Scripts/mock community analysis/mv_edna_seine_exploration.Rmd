...
ggplot() +
  geom_point(data = scrs3, aes(x = NMDS1, y = NMDS2, color = as.factor(habitat), shape = as.factor(type))) +
  stat_ellipse(data = scrs3, aes(x = NMDS1, y = NMDS2, color = as.factor(type))) +
  ggtitle("Nearshore fish community") +
  labs(x = "NMDS1", y = "NMDS2", size = 10)+ 
  geom_polygon(data = scrs.edna, aes(x = NMDS1, y = NMDS2, group = bay_year2), fill = NA, color = "gray") +
  geom_segment(data = vec.sp.dat.sig3, aes(x = 0, xend = MDS1, y = 0, yend = MDS2),
               inherit.aes=FALSE) +  # add arrows
  geom_label_repel(data = vec.sp.dat.sig3, aes(x = MDS1, y = MDS2, label = sp_code),
                   size = 4, inherit.aes = FALSE)

ggplot() +
  geom_point(data = scrs3, aes(x = NMDS1, y = NMDS3, color = as.factor(habitat), shape = as.factor(type))) +
  stat_ellipse(data = scrs3, aes(x = NMDS1, y = NMDS3, color = as.factor(type))) +
  ggtitle("Nearshore fish community") +
  labs(x = "NMDS1", y = "NMDS3", size = 10)+ 
  geom_polygon(data = scrs.edna, aes(x = NMDS1, y = NMDS3, group = bay_year2), fill = NA, color = "gray") +
...
ggplot() +
  geom_point(data = scrs3, aes(x = NMDS2, y = NMDS3, color = as.factor(habitat), shape = as.factor(type))) +
  stat_ellipse(data = scrs3, aes(x = NMDS2, y = NMDS3, color = as.factor(type))) +
  ggtitle("Nearshore fish community") +
  labs(x = "NMDS2", y = "NMDS3", size = 10)+ 
  geom_polygon(data = scrs.edna, aes(x = NMDS2, y = NMDS3, group = bay_year2), fill = NA, color = "gray") +
