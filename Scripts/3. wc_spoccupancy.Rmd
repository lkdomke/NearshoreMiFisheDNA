...
source(file = "Scripts/ppc_integratedMsPGOcc.R")
...
# note about MCMCplot - this defaults to plotting the median of the posterior samples
# rather than the mean that we looked at above, see ?MCMCplot
# png("Images/Trait_Detection_Params_030926.png", height = 8, width = 10, units = "in", res = 400)
MCMCplot(object = post.edna$beta.samples, # enda
         ...
         labels = c("Intercept [Scales, Solitary, Demersal]", 
                    ...
                    "Facultative schooling", "Obligatory schooling", "Both demersal/pelagic", "Pelagic"),
         sz_labels = 1.2,
         sz_med = 2, sz_thick = 6, sz_thin = 3)
legend(x = "topright", legend =c("eDNA", "Beach seines"),
       fill = c("#9c91ca", "#ac6162"), yjust = 1,
       title = "Sampling method", bty = "n", cex = 1.2)
#dev.off()
